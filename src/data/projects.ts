...
export const projectDefinitions: ProjectDefinition[] = [
...

  {
    ...
    completionSummary: '对千次调参记录分析后发现，专家与新手的最终调参结果无显著差异（p=0.07），但前者平均少喝了 2.3 杯咖啡。',
...

  {
    ...
    completionSummary: '调查显示，67% 的研究人员曾擦掉"非常重要"的内容，其中 23% 已无法复现，定理因此永久消失于学术史。',
...

  {
    ...
    completionSummary: '从 13000 篇论文的致谢段落中，还原出 891 个节点的学术人情网络，其中最核心的节点是一位默默无闻的审稿编辑。',
...

  {
    ...
    completionSummary: '顶会论文平均可压缩至原长度 18% 而不损失核心贡献，但局限性部分消失率高达 98%。这或许并非巧合。',
