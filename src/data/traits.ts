...
export const traitDefs: Record<string, TraitDef> = {
  ...
  reliable_senior: {
    ...
    effect: '每月随机为其他一位学生提升1点理论',  // 若其他学生不存在，则无事发生
  },
  ...
  social_terrorist: {
    ...
    effect: '每月随机使另一位学生好感+1', // 若没有其他学生，则无事发生
  },
  ...
  network_magnet: {
    ...
    effect: '负责的项目月推进-1%，但完成后声望额外+4',  // 月推进-1%指额外减少绝对值。例如原本月推进为5%，变为4%
  },
  ...
  research_mysticism: {
    ...
    effect: '负责的项目月推进在心情高于60时变为1.2倍，在心情低于40变为0.8倍',
  },
  ...
  optimization_addict: {
    ...
    effect: '每月随机使一个进行中的项目进度+1%',  // 不要求是自己负责的项目，但不能是停滞、待分配的项目。若没有项目符合，则无事发生
  },
