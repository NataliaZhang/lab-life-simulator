...
export const endingEvents: Record<string, GameEvent> = {
  ...
  ending_time_struggle: {
    ...
    description: [
      ...
      '气氛比你想象的更沉。委员会的问题一个接一个：发表数量为什么不够？学生流失是什么原因？经费这么紧张，后续怎么规划？你答了能答的，有两个问题你只说了"这方面确实做得不足"，然后沉默。王教授把你的发表记录翻了又翻，没有画问号，也没有点头，只是看。你不知道这代表什么。陈述结束时没有掌声，只有人在本子上写了什么。',
      '"请在外面等候。" 走廊的椅子很硬，饮水机滴滴答答地漏水。等了二十分钟，又是二十分钟。走廊里偶尔有路过的博士生，看见你，眼神往别处移，快步走了。你曾经起身想去倒杯水，但担心错过通知，又坐回去。第四十七分钟，你已经把能想的坏结果都想了一遍，心里反而平静了。',
    ...
    options: [
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '这句话听起来很悲观，但你说这话的时候却意外地平静。你见过有人撑不住提前离开这个行业。你还在这里——这不是失败，这是坚持。',
          phaseChange: 'won',
        }],
      },
      {
