...
export const dailyEvents: Record<string, GameEvent> = {
  ...
  gpu_oom: {
    ...
    description: [
      '{studentName}端着笔记本走进来，神情介于崩溃和平静之间。屏幕上：RuntimeError: CUDA out of memory. Tried to allocate 2.50 GiB。',
      '"batch size已经是1了。"',
    ],
    ...
    options: [
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '批了一台新卡，实验终于跑起来了。当晚{studentName}发来消息：loss在降。你长舒一口气。',
          effects: [
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '梯度累积一通操作，显存问题解决了，速度稍慢了点，但能跑。{studentName}回去继续调参了。',
            effects: [
          ...
          {
            weight: 1,
            narrative: '梯度累积设置错了，loss直接飞上天。{studentName}神情更崩溃了，回来又找你了。',
            effects: [
      ...
      },
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '换了个小模型，pipeline通了。虽然性能差点，但至少确认代码没问题，可以开始迁移正式模型了。{studentName}松了口气。',
          effects: [
  ...
  student_allnighter: {
    ...
    title: '凌晨三点还在群里',
    description: [
      '组会群里有条消息，时间戳是凌晨3:17，发消息的是{studentName}，附了一张手写公式的截图。"快推出来了，老师看看对不对。"',
      '你打了个哈欠，打开电脑。',
    ],
    ...
    options: [
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '你们通话到四点半，把公式彻底理清楚了。{studentName}兴奋地说"原来如此"。你第二天上午睡过头，差点误了个会议。',
          effects: [
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你发消息让{studentName}休息，明天再推。对方叹了口气说"好的老师"，关了电脑。第二天思路反而更清晰了，公式顺利解出来。',
            effects: [
              { type: 'randomStudent', stat: 'happiness', delta: 8 },
          ...
          {
            weight: 1,
            narrative: '你发消息让{studentName}先休息。回了个"好的"，没有感叹号。公式最终独自推出来了，但感觉你不太上心。',
            effects: [
      ...
      },
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '你问了一下timeline，发现其实不急。{studentName}这才松了口气，回去睡了。第二天状态很好，效率高了很多。',
          effects: [
  ...
  lab_meeting_drama: {
    ...
    description: [
      ...
      '{studentName}停顿了一下，回了句"我觉得没问题"，语气有点冷。空气凝固了几秒。',
    ],
    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你接过话题，说{studentName}和{student2Name}都有道理，建议会后各自补充实验再讨论。气氛缓和了，两人后来私下道了歉。',
            effects: [
              { type: 'randomStudent', stat: 'happiness', delta: 5 },
              { type: 'randomStudent', stat: 'favor', delta: 3 },
          ...
          {
            weight: 1,
            narrative: '你打了个圆场，但后来发现{studentName}和{student2Name}还是有点别扭。表面和解，暗流还在。',
            effects: [
              { type: 'randomStudent', stat: 'happiness', delta: -3 },
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你说"你们讨论一下"。{studentName}和{student2Name}激烈辩论了十分钟，最后{studentName}承认了一个小问题。碰撞出火花，学术进步。',
            effects: [
              { type: 'randomStudent', stat: 'skills.theory', delta: 5 },
          ...
          {
            weight: 1,
            narrative: '你说"你们讨论"，但{studentName}和{student2Name}都不说话了，陷入冷场。剩下的组会沉默地结束。',
            effects: [
              { type: 'randomStudent', stat: 'happiness', delta: -10 },
              { type: 'randomStudent', stat: 'favor', delta: -5 },
      ...
      },
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '你说{student2Name}的质疑有道理，让{studentName}好好考虑一下。{studentName}有点尴尬，但下次实验设计明显更严谨了。{student2Name}感觉被认可，心情不错。',
          effects: [
            { type: 'randomStudent', stat: 'happiness', delta: -5 },
            { type: 'randomStudent', stat: 'skills.theory', delta: 5 },
  ...
  nan_loss: {
    ...
    title: 'NaN loss了',
    description: [
      '{studentName}来敲你的门，表情空洞："老师，loss变NaN了。"',
      '日志看了，找不到原因。你深吸一口气。',
    ],
    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '讲到第三段时，{studentName}自己停下来了："啊……学习率太大了。" 橡皮鸭调试，屡试不爽。你没说一句话，问题解决了。',
            effects: [
              { type: 'randomStudent', stat: 'happiness', delta: 10 },
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: 'gradient clipping加上去，训练稳了。不是最优解，但问题解决了，{studentName}继续推进实验了。',
            effects: [
              { type: 'randomStudent', stat: 'happiness', delta: 8 },
          ...
          {
            weight: 1,
            narrative: '加了裁剪，loss不NaN了但也不收敛了，变成一条直线。{studentName}更迷茫了，问题得重新排查。',
            effects: [
              { type: 'randomStudent', stat: 'happiness', delta: -8 },
            ],
          },
      ...
      },
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '果然有几条样本有无穷大的值。清洗数据之后，{studentName}的训练一帆风顺。这种bug最难找但最值得找。',
          effects: [
            { type: 'randomStudent', stat: 'happiness', delta: 12 },
            { type: 'randomStudent', stat: 'skills.engineering', delta: 5 },
