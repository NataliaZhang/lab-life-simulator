...
export const idleEvents: Record<string, GameEvent> = {
  ...
  idle_lab_hum: {
    ...
    title: '服务器的嗡鸣',
    description: [
      '实验室里最稳定的声音，始终是服务器机柜的嗡鸣。不论外面发生什么，它都在转。这个月它转得格外顺，没有任何异常告警，日志文件干净得像一张新纸。你看着屏幕发了会儿呆，觉得这也是一种好日子。',
    ],
    tags: ['idle'],
  },
  ...
  idle_coffee_break: {
    ...
    title: '咖啡间隙',
    description: [
      '你去倒了杯咖啡，回来的时候发现自己顺路检查了走廊、看了一眼告示栏、在楼梯口站了两分钟。没什么事，就是站着。这个月大抵如此——平稳推进，没有惊喜也没有意外。科研就是这样，大多数时候是咖啡和等待。',
    ],
    tags: ['idle'],
  },
