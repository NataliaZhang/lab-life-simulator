    ...
    options: [
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你在群里发了一条消息，建议大家近期自行解决咖啡需求，等维修进度。群里挂着已读双勾一会儿，然后有人回了个"好的"。这条回复的信息量，需要结合对方平时的聊天风格才能解码——你大概解码出来了，但选择不去细想。两周后，实验室角落出现了三个不同品牌的便携咖啡杯，各自形成了一个独立的咖啡生态圈，互不干涉。',
            effects: [
              { type: 'allStudents', stat: 'happiness', delta: -8 },
    ...
    options: [
      {
        ...
        outcomes: [
          ...
          {
            weight: 1,
            narrative: '检测报告显示，送检样品成分复杂，注明"无法确认为已知驯化家禽来源"，建议依规处理。摊主被处以罚款，要求停业整顿。至于那具体是什么腿，报告写了"来源待定"。\n\n论坛随即炸开了锅——生物系、兽医系、烹饪学会的人全来参与辩论，用完全学术的语气讨论一只未知动物腿的物种归属。你的举报被官方定性为"提供了重要食品安全线索"。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 5 },
            ],
          },
