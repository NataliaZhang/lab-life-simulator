    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你写了一份逐条回应的申辩稿（业内称"rebuttal"，就是对着审稿意见一条一条正式反驳）。关于AGI那条，你用四段话平静地解释了为什么这篇论文不需要先解决AGI。大会程序主席大概被这份气质震惊了，随即拍板接受。群里的第一条消息是香槟表情，第二条是截图，第三条是"我要把这份申辩裱起来"。',
            effects: [
          ...
          {
            weight: 1,
            narrative: '你写了一份有理有据的申辩，附带对"通用人工智能"定义的文献梳理，温和指出该标准适用于全体AI论文。二号没有回应。论文以"审稿人分歧较大"为由送到了第四位审稿人那里。第四位写了两条意见：第一条是"为什么不考虑扩散模型"，第二条是"格式有问题"。',
            effects: [
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你把那条意见截图存进了专用文件夹，命名"二号经典收藏"，然后关掉投稿系统，打开新目标。改投IISC，两个月后论文过了，一号写道："本文思路清晰，实验充分。"你对着屏幕点了点头，感觉世界大体是公平的，只是有些会议活在另一个物理层上。',
            effects: [
          ...
          {
            weight: 1,
            narrative: '你换投了GRF。GRF的三号写道："本文方法有效，但缺乏对更广泛场景的泛化能力的讨论——在极端情况下，是否需要更强的推理能力？"你盯着这条意见看了很久，感觉ICOP那个二号换了个马甲，跟着你跑到了另一个会。',
            effects: [
    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你把清单全引了，措辞整进相关段落，格式整洁，上下文衔接尚可。论文过了。你和组里达成了一种默契，叫做"学术生存主义"：有用的引用读完，没用的放进去，不问对方是谁。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 2 },
              { type: 'allStudents', stat: 'happiness', delta: 3 },
            ],
          ...
          {
            weight: 1,
            narrative: '你把清单全引了，论文过了。但没过多久，有学者在学术论坛发了一篇分析，梳理了近期某批论文的引用来源，画了一张关系图，你的论文在图里出现了。你盯着那个节点看了很久，决定这件事什么都不知道。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: -2 },
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你仔细看完清单，找出真正与本文相关的几篇，整进综述，写了两句说明关联。三号在修改审中写道："作者文献引用仍不充分，但整体工作尚可接受。"论文勉强过了，像是被夹子夹着放进了接受列表。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 3 },
              { type: 'lab', stat: 'energy', delta: 5 },
            ],
          ...
          {
            weight: 1,
            narrative: '你只引了相关的几篇，在申辩里解释了选择标准。三号回复"这与我的建议明显不一致"，维持负面评价，论文以弱拒收场。组里有人低声问了一句"老师，他们是不是同一个人"，你没有回答，因为你不知道怎么回答。',
            effects: [
    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你写了一封主题明确、措辞精准的邮件，抄送了会议主席。三天后，你收到了投稿系统的自动回复："您的咨询已收到，我们将尽快处理。"然后又是三周已读不回。之后来了一封人工邮件，说"经查，您的稿件在系统更新中丢失，建议重新提交"。你盯着这行字反复读，感到人类的文明在某个节点出了岔子。',
            effects: [
              { type: 'lab', stat: 'energy', delta: -10 },
              { type: 'allStudents', stat: 'happiness', delta: -5 },
            ],
          ...
          {
            weight: 1,
            narrative: '你发了邮件。这一次程序主席回复了："非常抱歉，审稿人临时退出，您的论文被延误，我们现在重启流程，预计两周内有结果。"六周后，意见到了：条件接受。你把这段经历讲给同事听，对方问："那你这论文算在哪年发的？"你想了很久，没有答案。',
            effects: [
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你点了撤稿。等确认期间，你把论文格式换成了新会议的模板，排版调整好，参考文献对齐，一切就绪。重投之后两个月拿到接受通知。原来那个会议的系统后来发来邮件："您的论文已撤回，感谢您的参与。"你没有回复。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 3 },
          ...
          {
            weight: 1,
            narrative: '你撤稿，重投到另一个会。新会的一号写道："这篇论文我好像在哪里见过类似的工作，建议作者说明与现有工作的区别。"你很想告诉他，那篇"类似的工作"就是你自己的论文，它在另一个系统里量子叠加了好几个月。但你没有，你写了申辩，耐心解释了区别。',
            effects: [
              { type: 'lab', stat: 'energy', delta: -15 },
              { type: 'allStudents', stat: 'happiness', delta: -3 },
            ],
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你决定不再追问了。论文就这样悬在系统里，既非接受，也非拒绝，处于一种只有投稿系统才能实现的哲学状态。你在简历某个角落用括号写了"（审稿中）"，然后打开了下一篇论文的草稿。有时候，最好的应对是继续往前走。',
            effects: [
              { type: 'lab', stat: 'energy', delta: 10 },
    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你花了半天时间，把近几年的接受论文逐篇分类，找出了一个不起眼但风格相符的workshop。改了格式，投进去。两个月后接受，审稿人写道："这篇论文与本次研讨会的主题非常契合。"你把这句话截图，放进了专门存放"反转"的文件夹。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 3 },
              { type: 'allStudents', stat: 'happiness', delta: 8 },
            ],
          ...
          {
            weight: 1,
            narrative: '你认真调研，找出了几个可能合适的目标，投了最匹配的一个。审稿人写道："本文技术贡献尚可，但本会议更关注实证研究，建议考虑偏理论的会议。"你翻出第一封拒信——那个会议说"建议考虑更偏应用的场景"。你关掉了所有标签页，喝了杯水。',
            effects: [
              { type: 'lab', stat: 'energy', delta: -10 },
              { type: 'allStudents', stat: 'happiness', delta: -5 },
            ],
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你重写了引言和摘要，把"方法论贡献"改写为"实际系统影响"，调整了关键词，技术内容一字未动。投进另一个会，这次过了。审稿人写道："这项工作很好地契合了本会议的核心主题。"',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 4 },
          ...
          {
            weight: 1,
            narrative: '你改写了引言，精心调整了定位。投稿之后，审稿人写道："本文包装不够诚实，核心贡献定位模糊。"你意识到你把包装改得太过明显，让人一眼看出在包装。下次要更自然一点。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: -2 },
              { type: 'lab', stat: 'energy', delta: -8 },
            ],
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你把论文挂到了arxiv，写了一段简洁的说明，附上完整实验数据。没多久，有人转发了链接，评论是"这篇没发表的工作比好几篇正式论文都扎实"。你没有转发，但把那条评论收藏了。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 5 },
              { type: 'lab', stat: 'energy', delta: 5 },
            ],
    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你写了一封正式邮件给大会程序主席，列出了具体细节，说明审稿人可能接触过非公开信息，请求调查利益冲突。主席回复说会核查，论文送交新的审稿人，最终条件接受。没有人告诉你调查结果是什么，也没有人解释那些细节是怎么出现在意见里的。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 4 },
              { type: 'lab', stat: 'energy', delta: -15 },
            ],
          ...
          {
            weight: 1,
            narrative: '你向程序主席报告了。主席回复说"将认真对待您的反馈"，然后两周没有消息，之后来了一封审稿结论邮件，维持原有审稿人意见，结论是拒稿。你搞不清楚那封举报邮件有没有被人看过。',
            effects: [
              { type: 'lab', stat: 'energy', delta: -10 },
              { type: 'allStudents', stat: 'happiness', delta: -5 },
            ],
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你在申辩里对那个具体问题进行了详尽的补充实验，写得非常有针对性，仿佛你早就知道这会是核心争议——因为你确实知道。二号在修改审里说"作者已充分回应"，给了弱接受。你没有对外提过这件事，它成了一段只存在于你记忆里的经历。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 3 },
          ...
          {
            weight: 1,
            narrative: '你写了一份异常精准的申辩，直接回应了那组内部实验的问题。二号回复："作者的回应令人生疑，精准度超出正常范围。"论文被拒，理由是"存在某些程序性疑虑"。没有人解释这意味着什么。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: -4 },
              { type: 'lab', stat: 'energy', delta: -15 },
            ],
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你写了一份正常的申辩，没有提那些细节，按常规逐条回应了审稿意见。论文过了，二号的那条意见被归入"已解决"。你把原始截图存进了一个文件夹，文件夹名叫"备用"——这是第一个文件，不知道下面还会不会有东西放进来。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 2 },
              { type: 'lab', stat: 'energy', delta: 5 },
            ],
    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你把摘要字号改为10pt，导出PDF，确认格式无误，重新提交。这次进入了正常审稿流程，两个月后条件接受，没有一条意见涉及格式。你偶尔想起那次修改，觉得那是你整个科研生涯性价比最高的三分钟。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 5 },
              { type: 'allStudents', stat: 'happiness', delta: 5 },
              { type: 'allStudents', stat: 'projectProgress', delta: 5 },
          ...
          {
            weight: 1,
            narrative: '你改了字号重投。确认页面提示："请注意，重复提交可能被视为同一论文的第二次投稿，请确认符合会议规定。"你查遍官网，没有找到"同一论文重投"的相关规定。鼓起勇气提交了，好在论文进入了正常流程。',
            effects: [
              { type: 'lab', stat: 'energy', delta: -5 },
              { type: 'allStudents', stat: 'happiness', delta: 3 },
            ],
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你关掉了投稿系统，打开了一部纪录片，看了好一阵，然后去散了个步。第二天，你改完了格式，没有任何心理负担地重新提交。论文最终通过，审稿意见里有一条表扬是：摘要写得简洁。',
            effects: [
              { type: 'lab', stat: 'energy', delta: 15 },
              { type: 'allStudents', stat: 'happiness', delta: 5 },
            ],
    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你在申辩里附上了投稿系统的时间戳截图，把两篇论文的提交时间并排呈现，用一句话指出："本文提交时间早于引用工作上传时间整整半年，在时间顺序上，本文工作应当具有独立性和优先性。"大会程序主席大概觉得这个逻辑无从反驳，换了一位审稿人，论文过了。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 5 },
              { type: 'allStudents', stat: 'projectProgress', delta: 5 },
            ],
          ...
          {
            weight: 1,
            narrative: '你提交了清晰的时间线证明。二号回复："尽管如此，鉴于该工作已公开，本文需要更明确地说明差异化贡献。"你更新了相关章节，把差异写清楚，花了两周。论文最终接受，新增的那段把论文变得更完整了——代价只是你脑子里那段无声的抗议。',
            effects: [
              { type: 'lab', stat: 'energy', delta: -10 },
              { type: 'lab', stat: 'reputation', delta: 3 },
      ...
      },
      {
        ...
        outcomes: [
          ...
          {
            weight: 1,
            narrative: '你加了引用，写了差异说明，重新提交。一号说"本文与引用工作差异化贡献仍不够清晰"。你把两篇论文重新对比读了一遍，差异其实相当明显，只是被你写得太学术，让人看不出来。你改写了引言，换了组词，审稿终于通过了。',
            effects: [
              { type: 'lab', stat: 'energy', delta: -15 },
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你发现那篇论文投到了另一个你也在评审名单上的会议。你没有主动索取，但当系统把它分配到你的审稿列表时，你按下了接受键，写了一份认真、客观、相当严格的意见，每一条都有文献支撑，逻辑无懈可击。不出意料，你的论文同时被接受了。你感觉某种平衡在宇宙层面被恢复了。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 3 },
              { type: 'lab', stat: 'energy', delta: -10 },
              { type: 'allStudents', stat: 'projectProgress', delta: 5 },
    ...
    options: [
      {
        ...
        outcomes: [
          {
            weight: 1,
            narrative: '你发了邮件，礼貌地请求了解论文在哪个维度上不符合要求，以便改进。收到了一封模板回复："由于审稿量较大，编辑组无法为每一份初审结果提供详细说明。"你把这封邮件存进了那个叫"学术界运作机制"的文件夹，子文件夹数量这个月又多了一个。',
            effects: [
              { type: 'lab', stat: 'energy', delta: -5 },
              { type: 'allStudents', stat: 'happiness', delta: -3 },
            ],
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 2,
            narrative: '你打开了一直维护的备选会议列表，每个旁边标着截止日期、录用率、适合的论文类型。锁定下一个目标，改格式，三天内重新投出去。两个月后拿到接受通知。效率有时候是一种防御机制。',
            effects: [
              { type: 'lab', stat: 'reputation', delta: 3 },
              { type: 'allStudents', stat: 'happiness', delta: 5 },
          ...
          {
            weight: 1,
            narrative: '你立刻打开备选列表，选了第二名，当晚改好格式准备提交，发现这个会议的截止日期是昨天。只能把标签页关掉，打开第三名，反复确认日期，第二天重新提交。',
            effects: [
              { type: 'lab', stat: 'energy', delta: -10 },
              { type: 'allStudents', stat: 'happiness', delta: 3 },
            ],
