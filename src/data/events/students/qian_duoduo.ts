...
export const qianDuoduoEvents: Record<string, GameEvent> = {
  ...
  qdd_first_meeting: {
    ...
    title: '钱多多：灵魂第一问',
    description: [
      '钱多多是组里最新来的博士生。你第一次找他正式谈话，花了二十分钟介绍研究方向——技术路线、数据来源、现有的未解决问题，讲得条理清晰，相当专业。',
    ...
    options: [
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '你告诉他，博士阶段的核心任务是把科学问题做扎实，落地是后面的事。钱多多听完，把小本本合上，说"老师说得对，我先把研究弄明白"。他收起了草图，但你注意到他在本本封面上标了一行字——"备用：等论文出来再看"。那个"备用"两个字，让你有说不清的感受，仿佛他在自己的任务栏里给这个想法挂了个"挂起"状态，随时可以恢复。',
          effects: [
  ...
  qdd_group_meeting_derail: {
    ...
    description: [
      ...
      '话题就此跑偏了整整二十分钟。有人开始分析竞品，有人估算市场规模，原本的实验数据被晾在白板上，像一道没人认领的课后作业。钱多多在中间画了一个商业模型图，画得极其认真，丝毫不觉得自己做了什么出格的事。',
    ],
    prompt: '组会被带偏了，你选择：',
    triggerConditions: [
      { type: 'time', field: 'year', op: '>=', value: 1 },
    ...
    options: [
      ...
      },
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '你示意他继续。钱多多把定价逻辑讲完，话锋一转，指出如果选订阅制，优化目标应该从单次准确率换成用户留存率——而这恰好和对照组那个"异常"数据有关：那个偏差在留存率视角下其实是合理的。组会多花了二十分钟，但大家对"我们为什么优化这个指标"有了更清楚的共识。有时候跑题是因为大脑在更高的层次上没有跑题。',
          effects: [
    ...
    options: [
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '你直接告诉他，未发表的数据不能出现在公开场合——不是规矩问题，是保护实验室和他自己。钱多多皱了下眉，问"那这一页只剩方向描述，没有数据，能撑住吗？"你说可以，技术验证可以用"内测结果"配上定性用户反馈。他想了五秒，点头，重新打开PPT开始改。改完之后那页比原来更简洁，逻辑没有削弱——他在压力下的执行力，比你预想的要好。',
          effects: [
            { type: 'student', studentId: 'qian_duoduo', stat: 'favor', delta: 5 },
            { type: 'student', studentId: 'qian_duoduo', stat: 'happiness', delta: 3 },
            { type: 'student', studentId: 'qian_duoduo', stat: 'skills.social', delta: 3 },
    ...
    options: [
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '你简单介绍了实验室的研究方向，技术层面讲得清楚，商业化部分用了"探索阶段"一笔带过。投资人听完点头，说"做得很扎实"。参观结束后，你拉着钱多多说了两句：以后带任何外部人来实验室，必须提前告知。他点头，没有解释，说了句"老师，对不起，我考虑不周"——没有多余的话，承认得很干脆，干脆得让你有点无处发力。',
          effects: [
            { type: 'student', studentId: 'qian_duoduo', stat: 'favor', delta: -5 },
            { type: 'student', studentId: 'qian_duoduo', stat: 'happiness', delta: -5 },
            { type: 'lab', stat: 'reputation', delta: 2 },
    ...
    options: [
      {
        ...
        outcomes: [{
          ...
          effects: [
            { type: 'student', studentId: 'qian_duoduo', stat: 'favor', delta: 12 },
            { type: 'student', studentId: 'qian_duoduo', stat: 'happiness', delta: 10 },
            { type: 'student', studentId: 'qian_duoduo', stat: 'projectProgress', delta: 8 },
    ...
    options: [
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '你回了他："看到了，这个反馈很真实，方向是对的。"他立刻回："老师我知道了！需求是真的！不是我自己猜的！"后面跟了一串感叹号，比他平时说话时的措辞活跃得多，像是长期压着的某种确认终于被解开了。你们没有继续聊，但那条对话你没有删。有时候，一件事情被真实的人需要，就已经是一个完整的意义了。',
          effects: [
            { type: 'student', studentId: 'qian_duoduo', stat: 'favor', delta: 10 },
            { type: 'student', studentId: 'qian_duoduo', stat: 'happiness', delta: 15 },
            { type: 'lab', stat: 'reputation', delta: 2 },
          ],
        }],
      },
      {
        ...
        outcomes: [{
          weight: 1,
          narrative: '你告诉他，用户的正向反馈是很好的信号，但要转化成论文里能引用的用户研究，这个证据才能正式成立。钱多多停顿了一下，回："老师，我能不能先高兴一会儿？"你看了一眼那条消息，回了个"可以"。他又过了十分钟才发下一条："好，我去设计一个正式的用户研究协议。"情绪和工作，他都会处理，顺序是先情绪，后工作，执行起来一点也不含糊。',
          effects: [
            { type: 'student', studentId: 'qian_duoduo', stat: 'favor', delta: 5 },
            { type: 'student', studentId: 'qian_duoduo', stat: 'happiness', delta: 8 },
            { type: 'student', studentId: 'qian_duoduo', stat: 'projectProgress', delta: 5 },
