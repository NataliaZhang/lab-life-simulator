...
half_favor_xie_zhiwei: {
  ...
  description: [
    ...
    '你在实验室里问了一圈，最后有人指了指角落：「好像是谢之微弄的。」',
    '找到谢之微的时候，她正蹲在地上整理一个拆开的插线板。听见你的问题，只是点点头：「嗯，顺手修了一下。」你追问怎么修的，她想了想：「拆开看了一下，换了个磨损的滚轮，清了灰，重新校了位置。」好像在说顺手扶正了一张椅子。',
    '你正准备说什么，她忽然补充了一句：「那个卡纸声音真的很烦。」停顿一下，又补一句：「而且每次看你们排队拍打印机，效率太低了。」',
  ],
  prompt: '你看着偷偷把打印机修好的谢之微：',
  options: [
    {
